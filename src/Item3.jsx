      ...
      "list": [
        {
          ...
          "weather": [{ "id": 500, "main": "Rain", "description": "clear sky", "icon": "01d" }]
        },
        {
          "dt": 1661943600,
          "temp": { "day": 295.76, "min": 287.73, "max": 295.76, "night": 289.37, "eve": 292.76, "morn": 287.73 },
          "weather": [{ "id": 500, "main": "Rain", "description": "light rain", "icon": "10d" }]
        },
        {
          "dt": 1662030000,
          "temp": { "day": 293.38, "min": 287.06, "max": 293.38, "night": 287.06, "eve": 289.01, "morn": 287.84 },
          "weather": [{ "id": 500, "main": "Rain", "description": "haze", "icon": "50d" }]
        },
        {
          "dt": 1661857200,
          "temp": { "day": 299.66, "min": 288.93, "max": 299.66, "night": 290.31, "eve": 297.16, "morn": 288.93 },
        ...
        },
        {
          "dt": 1661943600,
          "temp": { "day": 295.76, "min": 287.73, "max": 295.76, "night": 289.37, "eve": 292.76, "morn": 287.73 },
          "weather": [{ "id": 500, "main": "Rain", "description": "scattered clouds", "icon": "03d" }]
        },
        {
          "dt": 1662030000,
          "temp": { "day": 293.38, "min": 287.06, "max": 293.38, "night": 287.06, "eve": 289.01, "morn": 287.84 },
        ...
        },
        {
          "dt": 1661943600,
          "temp": { "day": 295.76, "min": 287.73, "max": 295.76, "night": 289.37, "eve": 292.76, "morn": 287.73 },
          "weather": [{ "id": 500, "main": "Rain", "description": "overcast couds", "icon": "04d" }]
        },
      ]
    };
    ...
    <div className="item item3">
      {dailyForecast.map((day, index) => (
        <div key={index} className={`day day${index + 1}`}>
          ...
          <p className='dailyicon'><img src={day.icon}></img></p>
