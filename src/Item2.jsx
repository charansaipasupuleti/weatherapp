        ...
        {isFetching ? (
          ...
          <>
            ...
            <div className='body body4'>
              <p>Feels Like:<br />{weatherData.feelslike}</p>
            </div>
            <div className='body body5'>
              <p>Humidity:<br />{weatherData.humidity}</p>
            </div>
            <div className='body body6'>
              <p>Wind Speed:<br />{weatherData.windSpeed}</p>
            </div>
            <div className='body body7'>
              <p>Visibility:<br />{weatherData.visibility}</p>
            </div>
            <div className='body body8'>
              <p>Weather:<br />{weatherData.description}</p>
            </div>
          </>
        )}
      </div>
